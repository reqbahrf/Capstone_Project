...
<nav class="sidenav">
   <ul class="navbar-nav">
    <li class="nav-item">
      <a href="#">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" width="20" height="20">
          <path d="M18.976563 23L22 20.984375L16.480469 13L22 5.015625L18.976563 3L11.980469 13 Z M 10.960938 23L14.019531 20.984375L8.5 13L14.019531 5.015625L10.960938 3L4 13Z" fill="#5B5B5B" />
        </svg>
        Minimize
      </a>
    </li>
    ...
    <li class="nav-item">
      <a href="#">
        <svg width="20" height="20" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg" mirror-in-rtl="true">
          <path fill="#5B5B5B" stroke="#5B5B5B" stroke-width="1" d="M8 6H5c-.553 0-1-.448-1-1s.447-1 1-1h3c.553 0 1 .448 1 1s-.447 1-1 1zM13 10H5c-.553 0-1-.448-1-1s.447-1 1-1h8c.553 0 1 .448 1 1s-.447 1-1 1zM13 14H5c-.553 0-1-.448-1-1s.447-1 1-1h8c.553 0 1 .448 1 1s-.447 1-1 1z"/>
          <path fill="#5B5B5B" stroke="#5B5B5B" stroke-width="1" d="M18 2v8c0 .55-.45 1-1 1s-1-.45-1-1V2.5c0-.28-.22-.5-.5-.5h-13c-.28 0-.5.22-.5.5v19c0 .28.22.5.5.5h13c.28 0 .5-.22.5-.5V21c0-.55.45-1 1-1s1 .45 1 1v1c0 1.1-.9 2-2 2H2c-1.1 0-2-.9-2-2V2C0 .9.9 0 2 0h14c1.1 0 2 .9 2 2z"/>
          <path fill="#5B5B5B" stroke="#5B5B5B" stroke-width="1" d="M23.87 11.882c.31.54.045 1.273-.595 1.643l-9.65 5.57c-.084.05-.176.086-.265.11l-2.656.66c-.37.092-.72-.035-.88-.314-.162-.278-.09-.65.17-.913l1.907-1.958c.063-.072.137-.123.214-.167.004-.01.012-.015.012-.015l9.65-5.57c.64-.37 1.408-.234 1.72.305l.374.65z"/>
        </svg>
