...
<nav class="sidenav">
  <ul class="navbar-nav">
    ...
    <li class="nav-item mb-2">
      <a href="#" id="dashboardLink" onclick="loadPage('adminDashboardTab.php', 'dashboardLink');" class="mb-2 d-flex align-items-center">
    ...
    <li class="nav-item mb-2">
      <a href="#" id="projectList" onclick="loadPage('adminProjectlistTab.php', 'projectList');" class="mb-2 d-flex align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="30" height="30">
    ...
    <li class="nav-item mb-2">
      <a href="#" id="userList" onclick="loadPage('adminUsersTab.php','userList');" class="mb-2 d-flex align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="30" height="30">
