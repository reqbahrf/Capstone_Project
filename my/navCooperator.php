  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item mb-2">
      <a href="#" id="requirementTab" onclick="loadPage('CooperatorRequirement.php','requirementTab');" class="mb-2 d-flex align-items-center">
        ...
        <span class="link-text ml-2">My Requirments</span>
      </a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item mb-2">
      <a href="#" class="mb-2 d-flex align-items-center">
        <span class="nav-text ml-2">UserName</span>
      </a>
    </li>
  </ul>
</nav>
