...
<nav class="sidenav">
   <ul class="navbar-nav">
    ...
    <li class="nav-item mb-2">
      <a href="#" id="dashboardLink" onclick="loadPage('staffDashboardTab.php','dashboardLink');" class="mb-2 d-flex align-items-center">
    ...
    <li class="nav-item mb-2">
      <a href="#"  id="projectLink" onclick="loadPage('staffProjectTab.php','projectLink');" class="mb-2 d-flex align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="30" height="30">
        ...
        <span class="link-text ml-2">Project</span>
      </a>
    </li>
    <li class="nav-item mb-2">
      <a href="#"  id="Applicationlink" onclick="loadPage('staffApplicantTab.php', 'Applicationlink');" class="mb-2 d-flex align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="30" height="30">
        ...
        <span class="link-text ml-2">Applicant</span>
      </a>
    </li>
    <li class="nav-item mb-2">
