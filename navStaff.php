...
<nav class="sidenav">
   <ul class="navbar-nav">
    ...
    <li class="nav-item mb-2">
      <a href="#" onclick="loadPage('staffDashboardTab.php');" class="mb-2 d-flex align-items-center"> 
    ...
    <li class="nav-item mb-2">
      <a href="#" onclick="loadPage('staffApplicantTab.php?page=applicant');" class="mb-2 d-flex align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="30" height="30">
