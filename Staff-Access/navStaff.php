...
<nav class="sidenav">
  <ul class="navbar-nav">
    ...
    <li class="nav-item mb-2">
      ...
      <a href="#" id="dashboardLink" onclick="loadPage('/Staff-Access/staffDashboardTab.php','dashboardLink');" class="mb-2 d-flex align-items-center">
    ...
    <li class="nav-item mb-2">
      ...
      <a href="#" id="projectLink" onclick="loadPage('/Staff-Access/staffProjectTab.php','projectLink');" class="mb-2 d-flex align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="30" height="30">
        ...
        <span class="nav-text ml-2">Project</span>
      </a>

    </li>
    <li class="nav-item mb-2">

      <a href="#" id="Applicationlink" onclick="loadPage('/Staff-Access/staffApplicantTab.php', 'Applicationlink');" class="mb-2 d-flex align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="30" height="30">
